...
def downloadPics(s, dishes, id2pic):
    ...
    for x in dishes:
        ...
        src = '../../../images/%d_%s.jpg' % (x.floor, picId)
        dst = '%d.jpg' % x.id
...
# url03 = 'https://portal.microsoftonline.com?wa=wsignin1.0'
# url03 = 'https://officerakuten.sharepoint.com/_forms/default.aspx?apr=1&amp;wa=wsignin1.0'
